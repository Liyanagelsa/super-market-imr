...
namespace Shop
{
    // Main form class for handling sales transactions
    public partial class SellingForm : Form
    {
        ...
        // Initialize seller name and current date when panel loads
        ...
        // Populate product details when a product is selected from the grid
        ...
        // Fetch products filtered by search text
        ...
        // Load initial data when form starts
        ...
        // Track grand total and item count
        int Gtotal = 0;
        int n = 0;
        ...
        // Handle selection of items in active sale for editing
        ...
        // Edit selected item in current sale
        ...
        // Delete selected item from current sale
        ...
        private void calculate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    change.Text = "LKR " + Convert.ToString(Convert.ToInt32(paid.Text) - Convert.ToInt32(Gtotal));
                }
            }
        }
        ...
        {
            // Print header
            e.Graphics.DrawString("Supermarket POS System", new Font("Ariel", 30, FontStyle.Bold), Brushes.Maroon, new Point(250));
            ...
            string top2 = "********************************************************\n\n";
            string topunder = "--------------------------------------------------------\n\n";
            string top3 = "Item\tPrice(LKR)\tQty\tTotal(LKR)\n";
            string down = "***********************************************************\n";
            ...
            // Print items and update database
            int n = 0, pt = 360;
        ...
        private void done_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                // Record transaction and reset form
                AddHist();
                activesale.Rows.Clear();
                totallb.Text = "";
                change.Text = "";
        ...
        // Refresh product list and clear search
        ...
        // Paint event for panel5
        private void panel5_Paint(object sender, PaintEventArgs e)
        {

        }

        // Constants and imports for window dragging functionality
